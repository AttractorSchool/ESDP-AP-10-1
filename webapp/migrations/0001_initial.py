    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_text', models.TextField(blank=True, max_length=3000, null=True, verbose_name='Текст запроса')),
                ('response_text', models.TextField(blank=True, max_length=3000, null=True, verbose_name='Ответ админа')),
