...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Наименование')),
                ('events_at', models.DateTimeField(validators=[webapp.models.events.validate_date_event], verbose_name='Дата мероприятия')),
                ...
                ('start_register_at', models.DateTimeField(default=None, null=True, validators=[webapp.models.events.validate_date_event], verbose_name='Дата начала регистрации')),
                ('end_register_at', models.DateTimeField(blank=True, null=True, validators=[webapp.models.events.validate_date_event], verbose_name='Дата конца регистрации')),
                ('description', models.TextField(max_length=3000, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Описание')),
                ('place', models.CharField(max_length=200, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Место')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(upload_to='user_pic', validators=[django.core.validators.validate_image_file_extension], verbose_name='Фото')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_of_voting_type', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Наименование типа голосования')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_to_vote', models.TextField(max_length=100, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Вопрос на голосование')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('option', models.TextField(max_length=100, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Вариант')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_of_the_vote', models.CharField(max_length=200, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Наименование голосования')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chat_name', models.CharField(max_length=200, verbose_name='Наименование')),
                ('description', models.TextField(max_length=3000, verbose_name='Описание')),
                ('rules', models.TextField(default=None, max_length=3000, verbose_name='Правила')),
                ...
                ('second_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_second_user', to=settings.AUTH_USER_MODEL, verbose_name='Второй пользователь')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('closed_at', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Дата закрытия')),
                ('approved', models.BooleanField(blank=True, default=None, null=True, verbose_name='Утвержден?')),
                ('request_text', models.TextField(blank=True, max_length=3000, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Текст запроса')),
                ('response_text', models.TextField(blank=True, max_length=3000, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Ответ админа')),
                ('is_deleted', models.BooleanField(default=False, verbose_name='Удалено')),
                ('chat_request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chat_admin_request', to='webapp.chatrequest', verbose_name='Запрос на создание чата')),
                ('sub_level', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_level', to='webapp.subscriptionlevel', verbose_name='Запрос на подписку')),
                ('user_reviewer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin_reviewer', to=settings.AUTH_USER_MODEL, verbose_name='Проверяющий')),
                ('user_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_request', to=settings.AUTH_USER_MODEL, verbose_name='Отправитель')),
            ],
        ),
    ]
